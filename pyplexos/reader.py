...
from xml_model import SolutionModel
from bin_model import SolutionData
...
class PlexosZipReader:
    ...
    def to_duck(self, path_to_dir: str) -> None:
        ...
        for table_name, table_data in self.solution_model.model_dump(
            ...
            if table_data is None:
                continue
            data = pl.from_dicts(table_data)
            conn.sql(f"CREATE TABLE {table_name} AS SELECT * FROM data")
